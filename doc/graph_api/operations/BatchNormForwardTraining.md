...
BatchNormForwardTraining supports in-place operations, meaning that `src`
can be used as both input and output (`dst`). In case of in-place operation, the
original `src` data will be overwritten. Use in-place operations whenever
