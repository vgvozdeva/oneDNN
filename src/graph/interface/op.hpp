...
#define CASE(k) \
    case (k): return #k
        ...
        switch (kind) {
            ...
            CASE(Wildcard);
            CASE(LastSymbol);
            CASE(_dnnl_mul_scales);
            CASE(_dnnl_constant_scales);
            CASE(_dnnl_add_zps);
            CASE(_dnnl_sub_zps);
            CASE(_dnnl_constant_zps);
            CASE(_dnnl_permute);
            CASE(_dnnl_to_group);
            CASE(_dnnl_from_group);
            CASE(_dnnl_unsqueeze);
            CASE(_dnnl_squeeze);
            CASE(_dnnl_reshape);
            CASE(_dnnl_transpose);
            CASE(_dnnl_convolution);
            CASE(_dnnl_convtranspose);
            CASE(_dnnl_pool);
            CASE(_dnnl_bn_folding);
            CASE(_dnnl_conv_bwd_data);
            CASE(_dnnl_batchnorm);
            CASE(_dnnl_binary);
            CASE(_dnnl_eltwise);
            CASE(_dnnl_eltwise_bwd);
            CASE(_dnnl_shuffle);
            CASE(_dnnl_sum);
            CASE(_dnnl_reduction);
            CASE(_dnnl_prelu);
            CASE(_dnnl_prelu_bwd);
            CASE(_dnnl_batchnorm_bwd);
            CASE(_dnnl_softmax_bwd);
            CASE(_dnnl_logsoftmax_bwd);
            CASE(_dnnl_resampling);
            CASE(_dnnl_resampling_bwd);
            CASE(_dnnl_concat);
            CASE(_dnnl_layernorm_bwd);
            CASE(_dnnl_conv_bwd_weights);
            CASE(_dnnl_pool_bwd);
            CASE(_dnnl_matmul);
            CASE(_dnnl_softmax);
            CASE(_dnnl_logsoftmax);
            CASE(_dnnl_layernorm);
            CASE(_dnnl_reorder);
            CASE(_dnnl_convtranspose_bwd_data);
            CASE(_dnnl_convtranspose_bwd_weights);
            CASE(_dnnl_groupnorm);
            CASE(_dnnl_gen_index);
            CASE(_dnnl_mask);
            CASE(_dnnl_sdpa);
            CASE(_dnnl_host_scalar);
            CASE(_dnnl_identity);
            CASE(_dnnl_dropout);
