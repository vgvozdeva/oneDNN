...
#ifndef GRAPH_BACKEND_DNNL_EXECUTABLES_GROUP_NORM_HPP
#define GRAPH_BACKEND_DNNL_EXECUTABLES_GROUP_NORM_HPP
...
#endif // GRAPH_BACKEND_DNNL_EXECUTABLES_GROUP_NORM_HPP
