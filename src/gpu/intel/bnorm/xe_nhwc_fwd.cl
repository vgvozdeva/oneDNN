...
__kernel void xe_calc_mean_var_nhwc(__global DATA_T *src,
    ...
    xe_mean_var_calc_fused_reduction(mean, variance, ic_block_offset, sum,
...
KERNEL_ATTR
__kernel void xe_bnorm_fwd_nhwc(__global DATA_T *src, __global float *mean,
